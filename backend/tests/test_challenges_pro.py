"""Challenges API requires Premium."""
...
def test_challenges_list_ok_premium(client, premium_auth_headers):
...
def test_create_challenge_ok_premium(client, premium_auth_headers, test_game):
    r = client.post(
        "/api/v1/challenges",
