...
def init_sqlite_tables():
    ...
    if insp.has_table("alembic_version"):
        return
    from app.models import user, user_favorite, user_prediction_view, user_push_token, push_reminder_sent, team, team_standing, game_player_spotlight, game, prediction, challenge, stripe_webhook_event, revenuecat_webhook_event  # noqa: F401
