...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "W27": ("done", "deploy_api.sh alembic + INVITE_BETA_OPS.md cutover (migration 020)"),
    "W28": ("done", "prometheus_metrics.py + SLO_AND_CAPACITY.md + load/chaos scaffolds (#18)"),
    ...
    "W33": ("done", "Annual IAP + SUBSCRIPTION_OFFER_POLICY founder phase (#19) + verify_subscription_offer_scaffold.sh; ASC product ops-only"),
    ...
    "W45": ("done", "SUBSCRIPTION_TIERS.md + SUBSCRIPTION_OFFER_POLICY.md — premium_plus legacy; founder vs public_list"),
    ...
    "I12": ("done", "deploy_api.sh migrations + docs/INVITE_BETA_OPS.md"),
    "I13": ("done", "CI Ruff"),
    ...
    "I20": ("done", "check_api_health.sh + check_uptime.sh; SLO targets in SLO_AND_CAPACITY.md"),
    ...
    "I41": ("done", "annual plan + SUBSCRIPTION_OFFER_POLICY founder/$29.99 gates; ASC IAP ops-only"),
    ...
    "I60": ("done", "Prometheus + Grafana; load/chaos scaffold + verify_slo_scaffold.sh (#18)"),
    ...
    "I87": ("done", "paywall_price_tier promo + founder offer phase (#19); RevenueCat checkout primary"),
