...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "I39": ("partial", "FeedSkeleton/FeedErrorBanner/FeedEmptyState on Favorites, LiveHub, Games"),
    ...
    "I83": ("partial", "PredictionDisclaimer on mini cards, Favorites, LiveHub, Paywall, GameDetail, Games"),
