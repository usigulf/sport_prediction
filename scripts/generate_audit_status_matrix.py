...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "W2": ("partial", "docs/PRODUCTION_REALITY.md + ARCHITECTURE.md banner"),
    ...
    "W32": ("partial", "odds_service edge_pct + /stats/model-vs-market dashboard"),
    ...
    "I28": ("partial", "docs/PRODUCTION_REALITY.md canonical prod facts"),
    ...
    "I49": ("partial", "web/scorecard.html weekly public-audit scorecard"),
    ...
    "I62": ("partial", "GET /games/{id}/line-movement + odds_snapshots on market-odds fetch"),
    "I63": ("partial", "CLV in GET /user/me/picks/brier from odds_snapshots"),
    ...
    "I88": ("partial", "intro_offer_variant experiment bucket in /config/feature-flags"),
    "I89": ("partial", "rewarded_ads_messaging experiment bucket"),
    "I90": ("partial", "ad_density experiment bucket"),
