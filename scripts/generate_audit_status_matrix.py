...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "W2": ("partial", "ARCHITECTURE.md still aspirational; mobile/docs/APP_STORE_METADATA_COPY.md accurate"),
    ...
    "W14": ("partial", "HomeScreen split; GameDetailScreen/PaywallScreen still large"),
    ...
    "W17": ("partial", "VoiceOver on tabs/cards; not exhaustive"),
    ...
    "W23": ("partial", "archive/README.md; ARCHITECTURE.md partially updated"),
    "W24": ("partial", "archive/services/; services/users/ legacy"),
    ...
    "W32": ("partial", "backend/app/services/odds_service.py edge_pct; FEATURE_ODDS_DISPLAY flag"),
    "W33": ("partial", "Annual Stripe + Paywall gating; ASC product com.octobetiq.premium.annual blocked"),
    "W34": ("partial", "backend/app/api/v1/user.py referral/apply, share_referral_service.py"),
    ...
    "W38": ("partial", "React Query hooks reduce refetch; GameDetailScreen still heavy"),
    ...
    "I26": ("partial", "backend/models/metrics.json example"),
    "I27": ("partial", "archive/README.md"),
    "I28": ("partial", "ARCHITECTURE.md"),
    "I29": ("open", "walk_forward_backtest no market benchmark yet"),
    ...
    "I34": ("partial", "GameCard/Landing accessibility labels"),
    "I35": ("done", "password reset flow"),
    "I36": ("done", "push consent order"),
    "I37": ("done", "mobile manageSubscriptions.ts"),
    "I38": ("partial", "PaywallScreen hero copy"),
    "I39": ("partial", "PremiumFeatureEmptyState; not all screens"),
    "I40": ("done", "guest paywall preview"),
    "I41": ("partial", "annual plan code; ASC IAP blocked"),
    "I42": ("partial", "referral/apply tracking; bonus days need ASC/Stripe promo"),
    ...
    "I45": ("partial", "push_trigger_service kickoff/high-conf/post-game"),
    "I46": ("partial", "send_trial_ending_reminders push; email via digest when SMTP set"),
    "I47": ("done", "mobile storeReview.ts"),
    "I48": ("done", "web/widgets/accuracy-widget.html"),
    "I49": ("open", "No blog/scorecard CMS"),
    ...
    "I61": ("partial", "odds_service + MarketOddsCard behind flag"),
    "I62": ("open", "Line movement charts"),
    "I63": ("open", "CLV tracker"),
    "I64": ("open", "Model vs market dashboard"),
    "I65": ("partial", "player_props_service behind FEATURE_PLAYER_PROPS"),
    "I66": ("open", "Parlay correlation warnings"),
    "I67": ("partial", "email_digest_service.py + /internal/email-digest/run; SMTP required"),
    "I68": ("partial", "favorites API sync; no conflict resolution UI"),
    "I69": ("partial", "iPad screenshots; layouts not fully optimized"),
    "I70": ("open", "iOS widget extension not shipped"),
    "I71": ("done", "CI coverage ≥60%"),
    "I72": ("done", "backend/tests/test_stripe_webhook.py"),
    "I73": ("partial", "free tier + share tests; no dedicated paywall bypass suite"),
    "I74": ("open", "CI uses SQLite not Postgres service container"),
    "I75": ("done", "mobile subscription.test.ts + CI"),
    "I76": ("partial", "mobile/e2e/paywall.e2e.ts + docs/DETOX_E2E.md skeleton"),
    "I77": ("done", "backend/app/services/feature_flags.py, GET /config/feature-flags"),
    "I78": ("done", "docs/API_V2_PLAN.md"),
    "I79": ("open", "mobile uses hand-written api.ts"),
    "I80": ("partial", "archive/; legacy services/users"),
    "I81": ("done", "GET /user/me/export, gdpr_export_service.py"),
    "I82": ("done", "POST /user/me/privacy/ccpa-opt-out"),
    "I83": ("partial", "predictionTrust disclaimers; not audited on every screen"),
    "I84": ("open", "No age gate"),
    "I85": ("blocked", "Quarterly ASC privacy label — manual process"),
    "I86": ("partial", "experiments.trial_length_days in /config/feature-flags"),
    "I87": ("partial", "experiments.paywall_price_tier in /config/feature-flags"),
    "I88": ("open", "Lapsed user intro offer"),
    "I89": ("open", "Rewarded ads A/B"),
    "I90": ("open", "Ad density A/B"),
    "I91": ("open", "Feature store"),
    "I92": ("open", "Per-user Brier tracking"),
    "I93": ("open", "Community predictions"),
    "I94": ("done", "GET /stats/public-audit"),
    "I95": ("blocked", "Academic partnership — external"),
    "I96": ("blocked", "Hiring — external"),
    "I97": ("open", "Real-time injury feed"),
    "I98": ("open", "Weather enrichment"),
    "I99": ("open", "Ensemble when backtest proves lift"),
