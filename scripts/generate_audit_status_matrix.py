...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "W14": ("partial", "HomeScreen split; GameDetail favorites via useFavorites; PaywallHero extracted"),
    ...
    "W17": ("partial", "VoiceOver on tabs/cards/GameDetail favorites; carousel labels added"),
    ...
    "W38": ("partial", "React Query favorites + upcoming; GameDetail still Redux for predictions"),
    ...
    "I34": ("partial", "GameCard/Landing/BestPickMiniCard/GameDetail favorite a11y labels"),
    ...
    "I39": ("partial", "FeedSkeleton/FeedErrorBanner/FeedEmptyState; Favorites + LiveHub wired"),
    ...
    "I69": ("partial", "useLayout hook; Paywall wide layout; carousel still phone-width"),
    "I70": ("partial", "GET /feed/widget/top-pick + mobile/ios/TopPickWidget Swift template"),
    ...
    "I83": ("partial", "PredictionDisclaimer on mini cards, Favorites, LiveHub, PaywallHero"),
    "I84": ("done", "mobile AgeGateScreen + ageGateStorage.ts"),
    "I85": ("blocked", "Quarterly ASC privacy label — manual process"),
    "I86": ("partial", "trial_length_days wired in PaywallScreen via useServerFeatureFlags"),
    "I87": ("partial", "paywall_price_tier in flags; RevenueCat price still primary"),
    "I88": ("partial", "intro_offer_variant bucket exposed; mobile not wired"),
    "I89": ("partial", "rewarded_ads_messaging bucket exposed; mobile not wired"),
    "I90": ("partial", "ad_density helper; AdEngine still uses local rules"),
